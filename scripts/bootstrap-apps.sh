#!/usr/bin/env bash
# reference: https://github.com/onedr0p/cluster-template/blob/main/scripts/bootstrap-apps.sh
set -Eeuo pipefail
...
# Namespaces must exist before the ESO bootstrap credential is installed
