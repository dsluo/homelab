...
talos1's GPUs (3090 Ti + 3070) are normally held by **llmkube**
(`qwen3-6-27b-mtp`). A game session pod needs both (the wolf sidecar's
...
and an arbiter/KEDA (deferred). See issue #1109 for the full write-up. Until that's
resolved, drive it by hand.
